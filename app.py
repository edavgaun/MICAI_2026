...
# 2. Inject the Explicit Header text into the Sidebar layout
st.sidebar.markdown("## 🧭 Navigation Panel")
st.sidebar.markdown("---")

# 3. Define the pages pointing to their respective files with clean English titles
...
# 4. Boot and run the navigation sidebar suite
